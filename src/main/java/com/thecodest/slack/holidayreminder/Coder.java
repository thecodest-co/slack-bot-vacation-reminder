...
/**
 * This is an representation of The Codest employee. Each employee has Slack anc Calamari account.
 *
 * @param calamariEmployee  Calamari account
 * @param slackUser Slack account
 */
