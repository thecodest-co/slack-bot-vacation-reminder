...
/**
 * Deleting timesheet entry by id
 */
@Schema(description = "Deleting timesheet entry by id")
...
public class DeleteTimesheetEntryById {
	@SerializedName("id")
	private Long id = null;

	public DeleteTimesheetEntryById id(Long id) {
		this.id = id;
		return this;
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, deleteTimesheetEntryById.id);
	}
	...
	public String toString() {
		...
		sb.append("class DeleteTimesheetEntryById {\n");
