...
public class ProjectOut {
	...
	public ProjectOut name(String name) {
		this.name = name;
		return this;
	}
	...
	public boolean equals(Object o) {
		...
		ProjectOut projectOut = (ProjectOut) o;
		return Objects.equals(this.id, projectOut.id) && Objects.equals(this.name, projectOut.name);
	}
